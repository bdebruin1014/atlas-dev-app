...
// Property Management
const PMInspectionsPage = lazy(() => import('@/pages/property-management/PMInspectionsPage'));
const InspectionConductPage = lazy(() => import('@/pages/property-management/InspectionConductPage'));
...
const ConstructionDashboardPage = lazy(() => import('@/pages/construction/ConstructionDashboardPage'));
const JobsListPage = lazy(() => import('@/pages/construction/JobsListPage'));
const JobDetailPage = lazy(() => import('@/pages/construction/JobDetailPage'));
const SubcontractorsPage = lazy(() => import('@/pages/construction/SubcontractorsPage'));
...
const AppContent = () => (
  <Routes>
    ...
    <Route path="/project/:projectId/units-management" element={<ProtectedRoute><AppLayout><UnitsManagementPage /></AppLayout></ProtectedRoute>} />
    <Route path="/project/:projectId/lots" element={<ProtectedRoute><AppLayout><UnitsManagementPage /></AppLayout></ProtectedRoute>} />
    ...
    {/* Property Management */}
    <Route path="/property-management/inspections" element={<ProtectedRoute><AppLayout><PMInspectionsPage /></AppLayout></ProtectedRoute>} />
    <Route path="/property-management/inspections/:inspectionId/conduct" element={<ProtectedRoute><InspectionConductPage /></ProtectedRoute>} />
    <Route path="/property-management/inspections/:inspectionId" element={<ProtectedRoute><InspectionConductPage /></ProtectedRoute>} />
    ...
    {/* Construction Management Module */}
    <Route path="/construction" element={<ProtectedRoute><AppLayout><ConstructionDashboardPage /></AppLayout></ProtectedRoute>} />
    <Route path="/construction/jobs" element={<ProtectedRoute><AppLayout><JobsListPage /></AppLayout></ProtectedRoute>} />
    <Route path="/construction/jobs/new" element={<ProtectedRoute><AppLayout><JobDetailPage /></AppLayout></ProtectedRoute>} />
    <Route path="/construction/jobs/:jobId" element={<ProtectedRoute><AppLayout><JobDetailPage /></AppLayout></ProtectedRoute>} />
    <Route path="/construction/jobs/:jobId/*" element={<ProtectedRoute><AppLayout><JobDetailPage /></AppLayout></ProtectedRoute>} />
    <Route path="/construction/subcontractors" element={<ProtectedRoute><AppLayout><SubcontractorsPage /></AppLayout></ProtectedRoute>} />
    <Route path="/construction/subcontractors/:subId" element={<ProtectedRoute><AppLayout><SubcontractorsPage /></AppLayout></ProtectedRoute>} />
