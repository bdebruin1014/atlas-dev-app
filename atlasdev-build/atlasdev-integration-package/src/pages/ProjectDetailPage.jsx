...
import { ArrowLeft, Edit2, ChevronDown, FileText, Building2, Users, DollarSign, FolderOpen, ClipboardList, MapPin, Calendar, Landmark, HardHat, Truck, FileCheck, AlertTriangle, Receipt, Shield, Mail, MessageSquare, Video, Phone, Settings, TrendingUp, Package, PlusCircle, CreditCard, PieChart, ArrowUpRight, ArrowDownRight, Calculator } from 'lucide-react';
...
const ProjectDetailPage = () => {
  ...
  const project = {
    ...
    type: 'Spec Home',
    budgetType: 'spec-home', // Options: 'spec-home', 'horizontal-lot', 'btr', 'bts'
    units: 1,
    sqft: '2,214',
  ...
  const renderBudgetComponent = () => {
    // Render the appropriate budget component based on project type
    switch (project.budgetType) {
      case 'spec-home':
        return <IndividualSpecHomeBudget />;
      // Future: Add other budget types
      // case 'horizontal-lot':
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2"><p className="text-xs text-gray-500">Address</p><p className="font-medium">{project.address}</p></div>
                  <div><p className="text-xs text-gray-500">City</p><p className="font-medium">{project.city}</p></div>
                  <div><p className="text-xs text-gray-500">State</p><p className="font-medium">{project.state}</p></div>
                  <div><p className="text-xs text-gray-500">ZIP</p><p className="font-medium">{project.zip}</p></div>
                  <div><p className="text-xs text-gray-500">Zoning</p><p className="font-medium">{project.zoning}</p></div>
                </div>
                <div className="mt-4 h-32 bg-gray-100 rounded-lg flex items-center justify-center">
                  <div className="text-center text-gray-400"><MapPin className="w-6 h-6 mx-auto mb-1" /><span className="text-sm">Map View</span></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-white border rounded-lg p-4">
                ...
                <p className="text-2xl font-semibold text-[#047857]">$65,000</p>
                <p className="text-xs text-gray-500">16% margin</p>
              </div>
            </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                ...
                <Button className="bg-[#047857] hover:bg-[#065f46]"><PlusCircle className="w-4 h-4 mr-1" />Add Expense</Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-white border rounded-lg p-4">
                ...
                <p className="text-2xl font-semibold text-amber-600">$8,500</p>
              </div>
              <div className="bg-white border rounded-lg p-4">
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y">
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 font-medium">Framing Package</td>
                    <td className="px-4 py-3"><span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded text-xs">Hard Costs</span></td>
                    <td className="px-4 py-3">84 Lumber</td>
                    <td className="px-4 py-3 text-right font-medium">$24,000</td>
                    <td className="px-4 py-3"><span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs">Paid</span></td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-4 py-3">Dec 18, 2024</td>
                    <td className="px-4 py-3 font-medium">Foundation</td>
                    <td className="px-4 py-3"><span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded text-xs">Hard Costs</span></td>
                    <td className="px-4 py-3">ABC Concrete</td>
                    <td className="px-4 py-3 text-right font-medium">$12,000</td>
                    <td className="px-4 py-3"><span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs">Paid</span></td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-4 py-3">Dec 15, 2024</td>
                    <td className="px-4 py-3 font-medium">Building Permit</td>
                    <td className="px-4 py-3"><span className="bg-purple-100 text-purple-700 px-2 py-0.5 rounded text-xs">Soft Costs</span></td>
                    <td className="px-4 py-3">City of Greenville</td>
            ...
            <div className="bg-white border rounded-lg overflow-hidden">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y">
                  ...
                  <tr><td className="px-4 py-3">Upgrades</td><td className="px-4 py-3 text-right">$5,000</td><td className="px-4 py-3 text-right">$0</td><td className="px-4 py-3 text-right text-green-600">+$5,000</td><td className="px-4 py-3 text-right">0%</td></tr>
    ...
    <div className="flex h-[calc(100vh-40px)] bg-gray-50">
      <div className="w-56 bg-[#1e2a3a] flex-shrink-0 flex flex-col">
        <div className="p-3 border-b border-gray-700">
          ...
          <div className="mt-2"><span className="text-xs bg-amber-500 text-white px-2 py-0.5 rounded">{project.status}</span></div>
        </div>
